...
namespace ADSProject.Controllers { 
        ...
        public class EstudiantesController : ControllerBase
        {
            ...
            public ActionResult<string> AgregarEstudiante([FromBody] Estudiante estudiante)
            {
                ...
                {
                    //En caso de no cumplir con todas las validaciones se procede a retornar una respuesta
            ...
            public ActionResult<string> ActualizarEstudiante(int idEstudiante, [FromBody] Estudiante estudiante)
            {
                try
                {
                  //Verificar que todads lsd validaciones por atributo del modelo este correctas
                  if(!ModelState.IsValid)
                {
            ...
            public ActionResult<List<Estudiante>> ObtenerEstudiantes()
            {
                try
                {
                    List<Estudiante> lstEstudiantes = this.estudiante.ObtnerTodosLosEstudiantes();
